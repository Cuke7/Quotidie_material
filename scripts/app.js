...
function getEvangileFromNetwork() {
    return fetch(`https://my-servo.herokuapp.com/quotidieAPI/get_evangile`)
        .then((response) => {
...
function getSaintFromNetwork() {
    return fetch(`https://my-servo.herokuapp.com/quotidieAPI/get_saint`)
        .then((response) => {
            return response.json();
        })
        .catch(() => {
...
function getEvangileFromCache() {
    ...
    const url = `https://my-servo.herokuapp.com/quotidieAPI/get_evangile`;
    return caches
        .match(url)
        .then((response) => {
            if (response) {
...
function getSaintFromCache() {
    ...
    const url = `https://my-servo.herokuapp.com/quotidieAPI/get_saint`;
    return caches
        .match(url)
        .then((response) => {
            if (response) {
